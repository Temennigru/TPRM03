...
# Horizontal meters per second
def hormps2dps(speed):
    return inversehyperbola(speed, 0.0754066, -0.341198, 0.5427857930389587)

# Vertical up meters per second
def verumps2dps(speed):
    return inversehyperbola(speed, 0.50672, -1.22361, 0.4631660633517509)

# Vertical down meters per second
def verdmps2dps(speed):
    return inversehyperbola(speed, 2.19906, 1.09309, 1.253882355786545)

# Rotations per second
def rps2dps(speed):
    return inversehyperbola(speed, 506.928, 9.88439, 2.387241107285013)
